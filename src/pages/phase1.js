    ...
    <div>
        ...
        <div className="row4">
          ...
          <div
            className={`content-juicy-1 ${
              factorsArray.length > 0 &&
              (factorsArray[factorsArray.length - 1].juiciness === "2"
                ? "juicy"
                : "")
            }`}
          >
      ...
      <div className="buttons-div">
        <div className="button-div">
          <button className="view-database" onClick={goToPhase2}>
            Go to Phase 2
          </button>
        </div>

        <div className="button-div">
          <button className="view-database" onClick={goToDatabasePhase1}>
            View Database
          </button>
        </div>
      </div>
