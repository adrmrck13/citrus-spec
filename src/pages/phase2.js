      ...
      <div className="header">
        ...
        <div className="container">
          <div className="row1">
            ...
            <div className="content-1">
              ...
              <p className="input-temp">{factorsArray.length > 0 && (factorsArray[factorsArray.length - 1].Temp)}</p>
              <p className="celc">&deg;C</p>
            </div>

            <div className="content-humidity-color">
              <p className="factor">Humidity:</p>
              <p className="input-humidity">{factorsArray.length > 0 && (factorsArray[factorsArray.length - 1].Humidity)}</p>
              <p className="mg">&#37;</p>
            </div>

            <div className="content-3">
              <p className="factor">Time:</p>
              <p className="input-days">{factorsArray.length > 0 && (factorsArray[factorsArray.length - 1].Time)}</p>
        ...
        <div className="buttons-div">
          <div className="button-div">
            <button className="view-database" onClick={goToPhase1}>Go to Phase 1</button>
          </div>

          <div className="button-div">
            <button className="view-database" onClick={goToPhaseDatabase2}>View Database</button>
          </div>
        </div>
    </div>
 );
